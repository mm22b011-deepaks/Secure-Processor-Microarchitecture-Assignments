...
# Key elements
keys = [0xc7, 0xc1, 0x00, 0x46]  # k1, k2, k3, k4
...
for i in range(256):
    ...
    output_matrix[i] = inv_mixed[1]  # Ensure it's within 0x00 to 0xFF
...
# Display the final XOR result
print(f"Final XOR result of all S-Box Inverse Outputs: {final_xor_result:02x}")
